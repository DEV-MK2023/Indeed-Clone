  ...
  return (
    <div className="w-full sticky top-0 self-start h-[100vh] bg-white p-8 rounded-3xl shadow-lg border border-blue-200 md:flex flex-col overflow-y-auto">
      ...
      <div className="flex items-center gap-4 pt-5 pb-6 flex-wrap">
        <button
          onClick={handleApply}
          className={`text-base font-bold py-2 px-5 rounded-xl flex items-center gap-2 shadow-md ${loggedInUser
        ...
        <button
          onClick={handleSave}
          className={`p-2 rounded-lg border border-blue-300 ${loggedInUser
